...
complete -c codex -n "__fish_codex_using_subcommand exec; and not __fish_seen_subcommand_from resume help" -l local-provider -d 'Specify which local provider to use (lmstudio or ollama). If not specified with --oss, will use config default or show selection' -r
...
complete -c codex -n "__fish_codex_using_subcommand exec; and not __fish_seen_subcommand_from resume help" -l add-dir -d 'Additional directories that should be writable alongside the primary workspace' -r -f -a "(__fish_complete_directories)"
...
complete -c codex -n "__fish_codex_using_subcommand exec; and not __fish_seen_subcommand_from resume help" -l oss -d 'Use open-source provider'
complete -c codex -n "__fish_codex_using_subcommand exec; and not __fish_seen_subcommand_from resume help" -l full-auto -d 'Convenience alias for low-friction sandboxed automatic execution (-a on-request, --sandbox workspace-write)'
...
complete -c codex -n "__fish_codex_using_subcommand e; and not __fish_seen_subcommand_from resume help" -l local-provider -d 'Specify which local provider to use (lmstudio or ollama). If not specified with --oss, will use config default or show selection' -r
...
complete -c codex -n "__fish_codex_using_subcommand e; and not __fish_seen_subcommand_from resume help" -l add-dir -d 'Additional directories that should be writable alongside the primary workspace' -r -f -a "(__fish_complete_directories)"
...
complete -c codex -n "__fish_codex_using_subcommand e; and not __fish_seen_subcommand_from resume help" -l oss -d 'Use open-source provider'
complete -c codex -n "__fish_codex_using_subcommand e; and not __fish_seen_subcommand_from resume help" -l full-auto -d 'Convenience alias for low-friction sandboxed automatic execution (-a on-request, --sandbox workspace-write)'
complete -c codex -n "__fish_codex_using_subcommand e; and not __fish_seen_subcommand_from resume help" -l dangerously-bypass-approvals-and-sandbox -d 'Skip all confirmation prompts and execute commands without sandboxing. EXTREMELY DANGEROUS. Intended solely for running in environments that are externally sandboxed'
...
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp mcp-server app-server completion sandbox execpolicy apply resume cloud responses-api-proxy stdio-to-uds features help" -f -a "exec" -d 'Run Codex non-interactively'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp mcp-server app-server completion sandbox execpolicy apply resume cloud responses-api-proxy stdio-to-uds features help" -f -a "login" -d 'Manage login'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp mcp-server app-server completion sandbox execpolicy apply resume cloud responses-api-proxy stdio-to-uds features help" -f -a "logout" -d 'Remove stored authentication credentials'
...
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp mcp-server app-server completion sandbox execpolicy apply resume cloud responses-api-proxy stdio-to-uds features help" -f -a "mcp-server" -d '[experimental] Run the Codex MCP server (stdio transport)'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp mcp-server app-server completion sandbox execpolicy apply resume cloud responses-api-proxy stdio-to-uds features help" -f -a "app-server" -d '[experimental] Run the app server or related tooling'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp mcp-server app-server completion sandbox execpolicy apply resume cloud responses-api-proxy stdio-to-uds features help" -f -a "completion" -d 'Generate shell completion scripts'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp mcp-server app-server completion sandbox execpolicy apply resume cloud responses-api-proxy stdio-to-uds features help" -f -a "sandbox" -d 'Run commands within a Codex-provided sandbox'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp mcp-server app-server completion sandbox execpolicy apply resume cloud responses-api-proxy stdio-to-uds features help" -f -a "execpolicy" -d 'Execpolicy tooling'
...
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp mcp-server app-server completion sandbox execpolicy apply resume cloud responses-api-proxy stdio-to-uds features help" -f -a "responses-api-proxy" -d 'Internal: run the responses API proxy'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp mcp-server app-server completion sandbox execpolicy apply resume cloud responses-api-proxy stdio-to-uds features help" -f -a "stdio-to-uds" -d 'Internal: relay stdio to a Unix domain socket'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp mcp-server app-server completion sandbox execpolicy apply resume cloud responses-api-proxy stdio-to-uds features help" -f -a "features" -d 'Inspect feature flags'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp mcp-server app-server completion sandbox execpolicy apply resume cloud responses-api-proxy stdio-to-uds features help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
